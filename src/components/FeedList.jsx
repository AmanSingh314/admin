...
const FeedList = () => {
  ...
  const handleBlock = (id) => {
    dispatch(blockFeed(id))
      .unwrap()
      .then(() => toast.success("Feed blocked successfully!"))
      .catch(() => toast.error("Failed to block feed."));
  };

  const handleRemove = (id) => {
    dispatch(removeFeed(id))
      .unwrap()
      .then(() => toast.success("Feed removed successfully!"))
    ...
    <div className="p-6 bg-gray-100 rounded-xl shadow-lg drop-shadow-[0_10px_20px_rgba(0,0,0,0.5)]">
      ...
      <div className="flex justify-center items-center mt-4 space-x-4">
        ...
        <button
          ...
          disabled={currentPage === Math.ceil(pagination.totalRecords / feedsPerPage)}
          className={`px-4 py-2 rounded ${
